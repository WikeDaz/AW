...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`ID_transport`) REFERENCES `users` (`user_nif`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`ID_restaurant`) REFERENCES `users` (`user_nif`),
